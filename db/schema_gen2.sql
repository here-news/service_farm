...
CREATE TABLE core.entities (
    ...
    -- Multi-language support (ARCHITECTURE.md lines 169-198)
    ...
    -- Confidence (ARCHITECTURE.md lines 271-330)
...
CREATE TABLE core.edges (
    ...
    -- Temporal decay (ARCHITECTURE.md lines 201-227)
...
-- -----------------------------------------------------------------------------
-- EVENTS: Factual happenings (ARCHITECTURE.md lines 138-142)
...
CREATE TABLE core.events (
    ...
    -- Confidence (ARCHITECTURE.md event formation)
    confidence FLOAT DEFAULT 0.5,
