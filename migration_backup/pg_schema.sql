...
--
-- Name: content; Type: SCHEMA; Schema: -; Owner: herenews_user
--

CREATE SCHEMA content;


ALTER SCHEMA content OWNER TO herenews_user;

--
-- Name: SCHEMA content; Type: COMMENT; Schema: -; Owner: herenews_user
--
...
--
-- Name: core; Type: SCHEMA; Schema: -; Owner: herenews_user
--

CREATE SCHEMA core;


ALTER SCHEMA core OWNER TO herenews_user;

--
-- Name: SCHEMA core; Type: COMMENT; Schema: -; Owner: herenews_user
--
...
--
-- Name: edge_type; Type: TYPE; Schema: core; Owner: herenews_user
--
...
ALTER TYPE core.edge_type OWNER TO herenews_user;

--
-- Name: entity_type; Type: TYPE; Schema: core; Owner: herenews_user
--
...
ALTER TYPE core.entity_type OWNER TO herenews_user;

--
-- Name: find_entity_network(uuid, integer, double precision); Type: FUNCTION; Schema: core; Owner: herenews_user
--
...
ALTER FUNCTION core.find_entity_network(p_entity_id uuid, p_max_depth integer, p_min_confidence double precision) OWNER TO herenews_user;

--
-- Name: get_page_summary(uuid); Type: FUNCTION; Schema: core; Owner: herenews_user
--
...
ALTER FUNCTION core.get_page_summary(p_page_id uuid) OWNER TO herenews_user;

--
-- Name: update_updated_at_column(); Type: FUNCTION; Schema: core; Owner: herenews_user
--
...
ALTER FUNCTION core.update_updated_at_column() OWNER TO herenews_user;
...
--
-- Name: event_embeddings; Type: TABLE; Schema: content; Owner: herenews_user
--
...
ALTER TABLE content.event_embeddings OWNER TO herenews_user;

--
-- Name: TABLE event_embeddings; Type: COMMENT; Schema: content; Owner: herenews_user
--
...
--
-- Name: claim_embeddings; Type: TABLE; Schema: core; Owner: herenews_user
--
...
ALTER TABLE core.claim_embeddings OWNER TO herenews_user;

--
-- Name: event_embeddings; Type: TABLE; Schema: core; Owner: herenews_user
--
...
ALTER TABLE core.event_embeddings OWNER TO herenews_user;

--
-- Name: pages; Type: TABLE; Schema: core; Owner: herenews_user
--
...
ALTER TABLE core.pages OWNER TO herenews_user;

--
-- Name: TABLE pages; Type: COMMENT; Schema: core; Owner: herenews_user
--
...
--
-- Name: rogue_extraction_tasks; Type: TABLE; Schema: core; Owner: herenews_user
--
...
ALTER TABLE core.rogue_extraction_tasks OWNER TO herenews_user;

--
-- Name: event_embeddings event_embeddings_pkey; Type: CONSTRAINT; Schema: content; Owner: herenews_user
--
...
--
-- Name: claim_embeddings claim_embeddings_pkey; Type: CONSTRAINT; Schema: core; Owner: herenews_user
--
...
--
-- Name: event_embeddings event_embeddings_pkey; Type: CONSTRAINT; Schema: core; Owner: herenews_user
--
...
--
-- Name: pages pages_canonical_url_key; Type: CONSTRAINT; Schema: core; Owner: herenews_user
--
...
--
-- Name: pages pages_pkey; Type: CONSTRAINT; Schema: core; Owner: herenews_user
--
...
--
-- Name: rogue_extraction_tasks rogue_extraction_tasks_pkey; Type: CONSTRAINT; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_event_embeddings; Type: INDEX; Schema: content; Owner: herenews_user
--
...
--
-- Name: idx_pages_canonical_url; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_created_at; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_domain; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_embedding; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_language; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_metadata_gin; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_pub_time; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_status; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_pages_url; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_rogue_tasks_page_id; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: idx_rogue_tasks_pending; Type: INDEX; Schema: core; Owner: herenews_user
--
...
--
-- Name: pages update_pages_updated_at; Type: TRIGGER; Schema: core; Owner: herenews_user
--
