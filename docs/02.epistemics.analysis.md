# 02 — Why Now (Epistemic Rationale)
...
- Deep dive: `docs/05.epistemic-foundations.metabolism.md` (Jaynes-style plausibility, priors/posteriors, MaxEnt/coherence, calibration gaps, and concrete hardening steps)
...
It is **not** the technical epistemic mechanism. For the “how” (metabolism, auditability, hardening), read `docs/05.epistemic-foundations.metabolism.md`.
...
Prev: `docs/01.vision.md`  
Next: `docs/03.how-it-works.md`
