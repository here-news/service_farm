...
- `/graph` teaser as product: ship a shareable “LiveWorld Map” that demonstrates evidence-grounded events and drives inbound submissions (see `docs/23.product.teaser.graph.md`)
...
**Exit criteria**
- Weekly active usage: ≥3 sessions/week per pilot user
- ≥60% of auto-formed events judged "useful or mostly useful" (5-point rubric)
- ≥70% citation coverage (claims with source links)
...
- Upgrade teaser into an onboarding funnel: presets, permalinks, and “try your artifact” flow; instrument share→submit→return
...
**Exit criteria**
- D30 retention: ≥50% of pilot users active in week 4 after onboarding
- Alert precision: ≥75% of delivered alerts rated "relevant" by recipients
- ≥2 pilots requesting expansion (more seats, more topics)
...
- ≥10 resolved disputes with audit trail
- Abuse resistance: minimum 100 credits to stake, 1-hour cooldown on rapid staking, account age ≥7 days for high-impact actions
...
**Exit criteria**
- Median dispute resolution: ≤72 hours from filing to outcome
- Clear economic policy for stake outcomes: 80% to winners, 10% to curators, 10% burned
- Stripe integration live; ≥5 successful payouts completed
...
Prev: `docs/50.biz.plan.md`  
Next: `docs/52.biz.operations.md`
